...
description: "Call WhatTax from your own TypeScript server route without HTTP transport."
status: "draft"
---
...
2. Convert accepted fields into canonical WhatTax facts.
...
Use `WhatTax.safe.calculate` if your route should return expected failures
