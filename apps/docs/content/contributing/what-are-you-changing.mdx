...
| Change HTTP endpoint shape or SDK helper shape                                      | [Backward compatibility](./backward-compatibility.mdx)   | `@whattax/api-http` for transport contracts, `@whattax/sdk` for SDK facades                        |
