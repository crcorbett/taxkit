...
The endpoint contract is generated from `@whattax/http-api`.
...
- API definition: [`packages/http-api/src/api.ts`](../../../../packages/http-api/src/api.ts)
- Calculator group: [`packages/http-api/src/groups/calculators.ts`](../../../../packages/http-api/src/groups/calculators.ts)
