...
| HGI-202 — docs policy and public-maintainer separation | Completed locally; HGI-208 is next | Machine-checkable public, maintainer, generated, package-README, and accepted public-status/navigation ownership; see [`../documentation-audit/HGI-202-receipt.json`](../documentation-audit/HGI-202-receipt.json) |
