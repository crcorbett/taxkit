...
| Harness requalification | [`verification/harness-epochs.md`](verification/harness-epochs.md), [`verification/effectiveness.md`](verification/effectiveness.md), and [`documentation-audit/HGI-206-candidate.json`](documentation-audit/HGI-206-candidate.json) | HGI-206 records only its target-specific worker-visible epoch and local receipts. Independent grading and any task closure remain separate. |
