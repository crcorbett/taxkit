...
WhatTax documentation page. Each journey lives in its own file so agents can
...
| API consumer | Call WhatTax over HTTP and understand endpoint behaviour. | [API consumer](./documentation-user-journeys/api-consumer.md) |
...
| Documentation contributor | Write or update docs using WhatTax standards. | [Documentation contributor](./documentation-user-journeys/documentation-contributor.md) |
