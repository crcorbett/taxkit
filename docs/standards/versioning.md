...
WhatTax uses Changesets to manage package versions and package changelogs. The
root `CHANGELOG.md` is the curated release-train changelog for humans reading
the repository as one product.
