...
export class IncomeTaxBracket
  extends Schema.TaggedClass<IncomeTaxBracket>()("IncomeTaxBracket", {
...
export class IncomeTaxTable
  extends Schema.TaggedClass<IncomeTaxTable>()("IncomeTaxTable", {
    year: TaxYear,
...
const table2025_26 = new IncomeTaxTable({
  ...
  brackets: [
    new IncomeTaxBracket({ thresholdCents: Cents.make(0),          maxCents: Cents.make(1_820_000),  rate: taxRate(0),     baseTaxCents: Cents.make(0) }),
    new IncomeTaxBracket({ thresholdCents: Cents.make(1_820_000),  maxCents: Cents.make(4_500_000),  rate: taxRate(0.16),  baseTaxCents: Cents.make(0) }),
    new IncomeTaxBracket({ thresholdCents: Cents.make(4_500_000),  maxCents: Cents.make(13_500_000), rate: taxRate(0.30),  baseTaxCents: Cents.make(428_800) }),
