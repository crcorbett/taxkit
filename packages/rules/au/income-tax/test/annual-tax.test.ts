  ...
  it.effect(
    ...
    () =>
      Effect.gen(function* () {
        ...
        expect(
          moneyEquals(taxFreeThreshold.ledger.components[0]!.amount, aud(0))
        ).toBe(true);
        expect(
          moneyEquals(
            taxFreeThreshold.ledger.components[1]!.amount,
            audDollars(700)
          )
        ).toBe(true);
        ...
        expect(
          moneyEquals(
            litoFirstPhaseEnd.ledger.components[0]!.amount,
            audDollars(4288)
          )
        ).toBe(true);
        expect(
          moneyEquals(
            litoFirstPhaseEnd.ledger.components[1]!.amount,
            audDollars(325)
          )
        ).toBe(true);
        ...
        expect(
          moneyEquals(litoCeiling.ledger.components[1]!.amount, aud(0))
        ).toBe(true);
